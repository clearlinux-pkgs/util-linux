...
Source0  : https://mirrors.kernel.org/pub/linux/utils/util-linux/v2.40/util-linux-2.40.tar.xz
...
%prep
%setup -q -n util-linux-2.40
cd %{_builddir}/util-linux-2.40
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
pushd ..
cp -a util-linux-2.40 build32
popd
pushd ..
cp -a util-linux-2.40 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712166754
